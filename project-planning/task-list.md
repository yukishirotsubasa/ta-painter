...
| [drawing2](task-pool/drawing2.md) | 等待 | High | drawing1 | `DrawingController` 正式實作（按下拖曳，拖曳中即時預覽），縮放/resize 後線條不跑位（僅桌面，觸控見 drawing5） |
...
- `../docs/drawing.md` — 已實作畫線 spike（TrendLinePrimitive、按下拖曳 demo，正式 DrawingController 尚未實作）
